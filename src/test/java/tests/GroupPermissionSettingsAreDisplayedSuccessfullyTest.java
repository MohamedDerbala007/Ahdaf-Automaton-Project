...
public class GroupPermissionSettingsAreDisplayedSuccessfullyTest extends TestBase {
    ...
    @Test
    public void groupPermissionsSettingsAreDisplayedSuccessfully() throws InterruptedException 
    {
		...
		permissionsMenuObject.openGroupPermissionsSettings();
		permissionsMenuObject.openAdministratorsGroupPermissions();
		Thread.sleep(5000);
		permissionsMenuObject.giveAllPermissionsOnAllSystem();
		System.out.println("Administrators Group Have Permission On All System");
    }
}
