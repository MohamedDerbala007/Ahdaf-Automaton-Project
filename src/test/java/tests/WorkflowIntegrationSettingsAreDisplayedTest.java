...
public class WorkflowIntegrationSettingsAreDisplayedTest extends TestBase {
    ...
    @Test
    public void workflowIntegrationSettingsAreDisplayedSuccessfully() throws InterruptedException {
        ...
        integrationSettingsMenuObject.ClearAndAddWorkflowURL();
        integrationSettingsMenuObject.ClearAndAddWorkflowServiceURL();
        integrationSettingsMenuObject.SaveWorkflowIntegrationSettings();
        Thread.sleep(5000);
        Assert.assertEquals(integrationSettingsMenuObject.WorkflowURLTextbox.getAttribute("value"), "https://pshwork.com/Workflow");
        Assert.assertEquals(integrationSettingsMenuObject.WorkflowServiceURLTextbox.getAttribute("value"), "https://pshwork.com/WorkflowWebApi");
        System.out.println("URLs Of Workflow Integrations Are Set Successfully");
        ...
        Thread.sleep(5000);
        Assert.assertTrue(homeObject.WorkflowIntegrationIcon.isDisplayed());
        System.out.println("Workflow Integrarion Icon Is Displayed Successfully");
    }
}
